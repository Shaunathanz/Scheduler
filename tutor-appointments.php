...
<html>
<head>
    <link rel="stylesheet" type="text/css" href="../styles/style.css?stuffffff" media="screen" />
		...
		<div class="appointment-section">
			...
			<div class="row">
				<div class="submit_area">
					<div class="sub_group">
						<a href="tutor-home.php"><span class="sucess"><i class="icon-ok"></i></span><span class="acpt_sucess">Accept</span></a>
					</div>
					<div class="sub_group">
						<a href="tutor-home.php"><span class="declaine"><i class="icon-remove"></i></span><span class="dec_sucess">Decline</span></a>
					</div>
				</div>
			</div>
		</div>
    </div>
	<div class="appointment_foter_section">
		<ul>
