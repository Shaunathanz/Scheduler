...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2021 at 06:46 PM
...
(10, 1, '0000-00-00', 11, 12, 'Pre Calculus', 'Unconfirmed', 3, b'0'),
...
ALTER TABLE `appointment`
 ADD PRIMARY KEY (`tutor_id`,`date`,`time_start`), ADD KEY `appt_id` (`id`);
